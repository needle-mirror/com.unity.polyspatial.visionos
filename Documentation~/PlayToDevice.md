...
* To run the Play to Device Host on an _Apple Vision Pro device_, you can find the TestFlight link in the [following link](https://testflight.apple.com/join/FVMH8aiG).
...
7. Once connected, the Unity Editor will begin streaming your experience to the host in real time. You can then view, play, or interact with your experience via either editor or device; changes and interactions will automatically stay in sync.
